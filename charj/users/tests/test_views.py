...
from charj.users.forms import UserAdminChangeForm
from charj.users.models import User
from charj.users.tests.factories import UserFactory
from charj.users.views import UserRedirectView
from charj.users.views import UserUpdateView
from charj.users.views import user_detail_view
...
class TestUserRedirectView:
    def test_get_redirect_url(self, user: User, rf: RequestFactory):
        ...
        view.request = request
        assert view.get_redirect_url() == "/cards/"
